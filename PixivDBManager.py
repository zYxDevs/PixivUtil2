...
class PixivDBManager(object):
    ...
    def __init__(self, root_directory, target='', timeout=5 * 60):
        if target is None or len(target) == 0:
            ...
            PixivHelper.print_and_log('info', f"Using default DB Path: {target}")
        else:
            PixivHelper.print_and_log('info', f"Using custom DB Path: {target}")
...
##########################################
    def createDatabase(self):
        ...
        try:
            ...
            print('Error at createDatabase():', sys.exc_info())
            print('failed.')
            raise
        finally:
            c.close()
    ...
    def dropDatabase(self):
        try:
            ...
            print('Error at dropDatabase():', sys.exc_info())
            print('failed.')
            raise
        finally:
            c.close()
    ...
    def compactDatabase(self):
        ...
        try:
            ...
            print('Error at compactDatabase():', sys.exc_info())
            raise
        finally:
            c.close()
        print('done.')
...
##########################################
    def importList(self, listTxt):
        ...
        try:
            ...
            print('Error at importList():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def exportImageTable(self, name):
        ...
        try:
            ...
            result = c.fetchall()
            if result[0][0] > 10000:
                print('Row count is more than 10000 (actual row count:', result[0][0], ')')
                ...
                if answer == 'y':
                    ...
                    c.execute(f'''SELECT {key}
                                FROM {table}
                                ORDER BY member_id''')
                    im_list.extend(row[0] for row in c)
            else:
                c.execute(f'''SELECT {key}
                            FROM {table}
                            ORDER BY member_id''')
            ...
            print('Error at exportImageTable():', sys.exc_info())
            print('failed')
            raise
    ...
    def exportList(self, filename, include_artist_token=True):
        ...
        try:
            ...
            for row in c:
                ...
                if len(row[1]) > 0:
                    writer.write(f' {str(row[1])}')
                writer.write('\r\n')
            writer.write('###END-OF-FILE###')
        except BaseException:
            print('Error at exportList():', sys.exc_info())
            print('failed')
            raise
        finally:
    ...
    def exportDetailedList(self, filename):
        ...
        try:
            ...
            print(f'Error at exportDetailedList(): {str(sys.exc_info())}')
            print('failed')
            raise
        finally:
            c.close()
    ...
    def exportFanboxPostList(self, filename, sep=","):
        ...
        try:
            ...
            print(f'Error at exportFanboxPostList(): {str(sys.exc_info())}')
            print('failed')
            raise
        finally:
            c.close()
...
##########################################
    def printMemberList(self, isDeleted=False):
        ...
        try:
            ...
            print('Error at printMemberList():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def printImageList(self):
        ...
        try:
            ...
            print('Error at printImageList():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
...
##########################################
    def insertNewMember(self, member_id=0, member_token=None):
        try:
            ...
            print('Error at insertNewMember():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def selectAllMember(self, isDeleted=False):
        ...
        try:
            ...
            print('Error at selectAllMember():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def selectMembersByLastDownloadDate(self, difference):
        ...
        try:
            ...
            print('Error at selectMembersByLastDownloadDate():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def selectMemberByMemberId(self, member_id):
        try:
            ...
            print('Error at selectMemberByMemberId():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def selectMemberByMemberId2(self, member_id):
        try:
            ...
            print('Error at selectMemberByMemberId2():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def updateMemberName(self, memberId, memberName, member_token):
        try:
            ...
            print('Error at updateMemberName():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def updateSaveFolder(self, memberId, saveFolder):
        try:
            ...
            print('Error at updateSaveFolder():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def updateLastDownloadedImage(self, memberId, imageId):
        try:
            ...
            print('Error at updateLastDownloadedImage:', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def updateLastDownloadDate(self, memberId):
        try:
            ...
            print('Error at updateLastDownloadDate():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def deleteMemberByMemberId(self, memberId):
        try:
            ...
            print('Error at deleteMemberByMemberId():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def deleteCascadeMemberByMemberId(self, memberId):
        try:
            ...
            print('Error at deleteCascadeMemberByMemberId():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def setIsDeletedFlagForMemberId(self, memberId):
        try:
            ...
            print('Error at setIsDeletedFlagForMemberId():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
...
##########################################
    def insertImage(self, member_id, image_id, isManga=""):
        try:
            ...
            print('Error at insertImage():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def insertMangaImages(self, manga_files):
        try:
            ...
            print('Error at insertMangaImages():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def blacklistImage(self, memberId, ImageId):
        try:
            ...
            print('Error at blacklistImage():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def selectImageByMemberId(self, member_id):
        try:
            ...
            print('Error at selectImageByMemberId():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def selectImageByMemberIdAndImageId(self, member_id, image_id):
        try:
            ...
            print('Error at selectImageByMemberIdAndImageId():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def selectImageByImageId(self, image_id, cols='*'):
        try:
            c = self.conn.cursor()
            c.execute(
                f'''SELECT {cols} FROM pixiv_master_image WHERE image_id = ? AND save_name != 'N/A' ''',
                (image_id,),
            )
            return c.fetchone()
        except BaseException:
            print('Error at selectImageByImageId():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def selectImageByImageIdAndPage(self, imageId, page):
        try:
            ...
            print('Error at selectImageByImageIdAndPage():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def updateImage(self, imageId, title, filename, isManga=""):
        try:
            ...
            print('Error at updateImage():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def deleteImage(self, imageId):
        try:
            ...
            print('Error at deleteImage():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def deleteSketch(self, postId):
        try:
            ...
            print('Error at deleteSketch():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def cleanUp(self):
        ...
        try:
            ...
            print('Error at cleanUp():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def interactiveCleanUp(self):
        ...
        try:
            ...
            print('Error at interactiveCleanUp():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def replaceRootPath(self):
        ...
        print(f"Replacing {oldPath} to {self.rootDirectory}")
        ...
        try:
            ...
            c.execute(
                ...
                (oldPath, self.rootDirectory, f"{oldPath}%"),
            )
            ...
            print('Error at replaceRootPath():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
...
##########################################
    ...
    def insertPost(self, member_id, post_id, title, fee_required, published_date, post_type):
        try:
            ...
            print('Error at insertPost():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def insertPostImages(self, post_files):
        try:
            ...
            print('Error at insertPostImages():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def selectPostByPostId(self, post_id):
        try:
            ...
            print('Error at selectPostByPostId():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def updatePostUpdateDate(self, post_id, updated_date):
        try:
            ...
            print('Error at updatePostUpdateDate():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def selectFanboxImageByImageIdAndPage(self, post_id, page):
        try:
            ...
            print('Error at selectFanboxImageByImageIdAndPage():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def deleteFanboxPost(self, post_id, by):
        ...
        try:
            ...
            print('Error at deleteFanboxPost():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def cleanUpFanbox(self):
        ...
        try:
            ...
            print('Error at cleanUpFanbox():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def interactiveCleanUpFanbox(self):
        ...
        try:
            ...
            print('Error at interactiveCleanUpFanbox():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
...
##########################################
    ...
    def insertSketchPost(self, post):
        try:
            ...
            print('Error at insertSketchPost():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def insertSketchPostImages(self, post_id, page, save_name, created_date, last_update_date):
        try:
            ...
            print('Error at insertSketchPostImages():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def selectSketchImageByImageIdAndPage(self, post_id, page):
        try:
            ...
            print('Error at selectSketchImageByImageIdAndPage():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def selectSketchPostByPostId(self, post_id):
        try:
            ...
            print('Error at selectSketchPostByPostId():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def deleteSketchPost(self, post_id, by):
        ...
        try:
            ...
            print('Error at deleteSketchPost():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def cleanUpSketch(self):
        try:
            ...
            print('Error at cleanUpSketch():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
    ...
    def interactiveSketchCleanUp(self):
        ...
        try:
            ...
            print('Error at interactiveSketchCleanUp():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
...
##########################################
    ...
    def selectNovelPostByPostId(self, post_id):
        try:
            ...
            print('Error at selectNovelPostByPostId():', sys.exc_info())
            print('failed')
            raise
        finally:
            c.close()
...
##########################################
    ...
    def menu(self):
        ...
        print('x. Exit')
        return input('Select one? ').rstrip("\r")
        ...
        try:
            while True:
                ...
                if selection == '1':
                    ...
                    includeArtistToken = includeArtistToken.lower() == 'y'
